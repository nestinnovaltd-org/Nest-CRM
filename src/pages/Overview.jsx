...
const Overview = () => {
  ...
  const renderOverview = () => {
    ...
    return (
      <>
        {/* Mobile Welcome Card & Search */}
        <div className="dashboard-mobile-welcome-container">
        ...
        <div className="dashboard-col sidebar-column">
          <div className="dashboard-desktop-welcome-container">
            {/* User Profile Info */}
            <div className="profile-widget-header">
              <div className="profile-user-info">
                <span className="p-welcome">Hi, {currentUser?.fullName || currentUser?.name || 'User'}</span>
            ...
            {/* Sparkle Search Customer Records Button */}
            <button
              className="customer-records-sparkle-btn"
              onClick={() => setIsSearchOpen(true)}
              style={{
  ...
  return (
    <DashboardLayout>
      <div 
        ...
        style={currentUser?.account_type === 'super_admin' ? {
          position: 'relative',
          top: 0,
          background: 'transparent',
          backdropFilter: 'none',
