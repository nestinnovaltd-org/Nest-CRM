              ...
              <div className="section-body">
                <div className="form-grid-v3">
                  <div className="form-group-v3 full-width">
                    <label>Project Details & Media</label>
                    <div className="image-upload-wrapper">
                      ...
                      <div className="upload-controls" style={{ flex: 1 }}>
                        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                          <label className="upload-btn-label" style={{ margin: 0 }}>
                            <Plus size={16} />
                        ...
                        <p className="upload-hint" style={{ marginTop: '8px', fontSize: '11px' }}>
                          Recommended: 1200x800px. Max: 5MB (Auto-compressed).
                        </p>

                        <div className="form-grid-v3" style={{ marginTop: '1.5rem', gap: '1rem' }}>
                          <div className="form-group-v3">
                            <label style={{ fontSize: '0.8125rem' }}>Project Name <span>*</span></label>
                            <input 
                              name="projectName"
                              type="text" 
                          ...
                          <div className="form-group-v3">
                            <label style={{ fontSize: '0.8125rem' }}>Project Status <span>*</span></label>
                            <select 
                              name="projectStatus"
            ...
            <div className="footer-content">
              ...
              <div className="footer-btns">
                ...
                {currentStep < 5 ? (
                  ...
                  <>
                    <button type="button" className="btn-secondary-v3">Save Draft</button>
                    <Button variant="primary" type="submit" icon={Save} isLoading={isSubmitting}>Create Project</Button>
                  </>
                )}
              </div>
            </div>
